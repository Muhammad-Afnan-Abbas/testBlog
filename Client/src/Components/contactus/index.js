                       ...
                       <div className="container">
                          <form method="POST" action="/contactUs">
                            <div className="form-group">
                              <input type="text" className="email-bt" placeholder="name" name="Name"  onChange={(event) => this.handleName(event)}/>
                            </div>
                            <div className="form-group">
                              <input type="text" className="email-bt" placeholder="email" name="Email"  onChange={(event) => this.handleEmail(event)}/>
                            </div>
                            <div className="form-group">
                              <textarea className="massage-bt" placeholder="Message" rows="5" id="comment" name="text"  onChange={(event) => this.handleMessage(event)}></textarea>
                            </div>
                          </form>
                       </div> 
