...
class AllProducts extends Component {
  ...
  truncate = (str) => {
    if (str.length > 150) {
      return str.length > 150 ? str.substring(0, 68) + "..." : str;
    } else {
      return str;
    }
  };
  ...
  render() {
    const { products, newBlogs, openEditForm, loading} = this.state;
    return (
      // <div>
      //     <li>
                    ...
                    {products.map((i, index) => {
                      return (
                        <tr className="row100 body">
                          ...
                          <td className="cell100 column2">{this.truncate(i.content)}</td>
